...
export function PYUSDPaymentModal({
  ...
  const switchToSepoliaNetwork = async () => {
    try {
      ...
      addToast({
        ...
        title: "Network Switch Failed",
        message:
          "Please manually switch to Sepolia testnet in your Web3Auth settings",
      });
    }
  };
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "rgba(28, 0, 51, 0.9)" }}
    >
      <Card variant="pixel" className="w-full max-w-md">
        <CardHeader>
          <CardTitle
            className="flex items-center space-x-2 font-pixel text-sm"
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span
                className="text-xs font-pixel capitalize"
                style={{ color: "rgb(255, 255, 255)" }}
              >
                {walletType === "embedded"
                  ? "Web3Auth Wallet"
          ...
          >
            ...
            <div
              className="mt-3 pt-2 border-t-2"
          ...
          {txHash && (
            ...
            >
              <p
                className="text-xs font-pixel mb-1"
                style={{ color: "rgb(0, 255, 0)" }}
              >
                Transaction Successful
              </p>
              <p
                className="text-xs font-pixel break-all"
                style={{ color: "rgb(255, 255, 255)" }}
              >
                {txHash}
              </p>
          ...
          {/* Network Info */}
          <div
            className="text-xs font-pixel text-center space-y-1"
          ...
          >
            ...
            <div className="flex items-center justify-center space-x-2">
              ...
              <button
                onClick={() =>
                  window.open(
                    `https://sepolia.etherscan.io/address/${PYUSD_ADDRESS}`,
                    "_blank"
                  )
                }
                className="hover:opacity-80"
